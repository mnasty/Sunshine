...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    //the length of a day in millis
    private static final long DAY_IN_MILLIS = 1000 * 60 * 60 * 24;
    //unique notification id for daily notification
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            // Params at OWM's forecast API page
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        //supporting api 21 or above period
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    int iconId = Utility.getIcDrawable(weatherId);
                    Resources resources = context.getResources();
                    Bitmap largeIcon = BitmapFactory.decodeResource(resources,
                            Utility.getArtDrawable(weatherId));
