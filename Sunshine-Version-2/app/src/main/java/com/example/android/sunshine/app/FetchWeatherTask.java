...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    /* The date/time conversion code to be moved outside the asynctask
     */
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_temp_default));

        if (unitType.equals(mContext.getString(R.string.pref_units_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_temp_default))) {
    ...
    protected String[] doInBackground(String... postcode) {
        ...
        String locationQuery = postcode[0];
